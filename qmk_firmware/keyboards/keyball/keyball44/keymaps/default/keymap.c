...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_universal(
    KBC_SAVE   , _______, _______   , _______   , _______   , _______   ,             AML_TO  , _______  , _______  , _______     , _______   , _______    ,
    _______    , _______, _______   , _______   , _______   , _______   ,             KC_BTN3  , KC_BTN1  , KC_BTN2  , _______     , KC_BTN4   , KC_BTN5    ,
  ...
  [3] = LAYOUT_universal(
    ...
    _______  , _______  , _______   , _______   , _______   , KC_F1     ,             KC_F12   , KC_LALT  , _______  , _______     , _______   , _______ ,
